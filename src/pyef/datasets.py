...
def load_gefcom_load_2012() -> dict[str, pd.DataFrame]:
    ...
    df_temperature_1 = pd.melt(df_temperature_1, id_vars=["station_id"] + melt_cols, var_name="hour", value_name="temperature")
    ...
    df_temperature_2 = pd.read_csv(f"{filepath}/temperature_solution.csv").\
